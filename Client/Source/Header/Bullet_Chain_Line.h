...
class CBullet_Chain_Line : public CBullet
{
protected:
	explicit CBullet_Chain_Line(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CBullet_Chain_Line(const CBullet_Chain_Line& rhs);
	virtual ~CBullet_Chain_Line();
...
public:
	static CBullet_Chain_Line* Create(LPDIRECT3DDEVICE9 pGraphicDev, CGameObject* pOwner, const _vec3& vDir);
