...
class CBullet_Chain_Circle : public CBullet
{
protected:
	explicit CBullet_Chain_Circle(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CBullet_Chain_Circle(const CBullet_Chain_Circle& rhs);
	virtual ~CBullet_Chain_Circle();
...
public:
	static CBullet_Chain_Circle* Create(LPDIRECT3DDEVICE9 pGraphicDev, CGameObject* pOwner, const _vec3& vDir);
