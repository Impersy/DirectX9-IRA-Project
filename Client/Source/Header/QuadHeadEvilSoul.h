...
class CQuadHeadEvilSoul : public CMonster
{
	enum DIRECTION { LEFTTOP, LEFTBOTTOM, RIGHTTOP, RIGHTBOTTOM, DIREND };

private:
	explicit CQuadHeadEvilSoul(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CQuadHeadEvilSoul(const CQuadHeadEvilSoul& rhs);
	virtual ~CQuadHeadEvilSoul();
...
public:
	static CQuadHeadEvilSoul* Create(LPDIRECT3DDEVICE9 pGraphicDev);
