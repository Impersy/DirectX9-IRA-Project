...
class CStage_Boss1 : public Engine::CScene
{
private:
	explicit CStage_Boss1(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CStage_Boss1();
...
public:
	static	CStage_Boss1*		Create(LPDIRECT3DDEVICE9 pGraphicDev);
