#include "stdafx.h"
#include "..\Header\Fire_Pulse.h"
#include "Export_Function.h"
#include "SylphBow.h"


CFire_Pulse::CFire_Pulse(LPDIRECT3DDEVICE9 pGraphicDev)
	: CEffect(pGraphicDev)
{
}

CFire_Pulse::CFire_Pulse(const CFire_Pulse & rhs)
	: CEffect(rhs)
{
}

CFire_Pulse::~CFire_Pulse()
{
	Free();
}

HRESULT CFire_Pulse::Ready_GameObject(void)
{
	Add_Component();
...
_int CFire_Pulse::Update_GameObject(const _float& fTimeDelta)
{
...
void CFire_Pulse::LateUpdate_GameObject()
{
...
void CFire_Pulse::Render_GameObject()
{
...
HRESULT CFire_Pulse::Add_Component(void)
{
	...
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Engine::Clone_ProtoComponent(L"Proto_Texture_Player_Bow_Fire_Pulse"));
	 
	m_uMapComponent[ID_STATIC].insert({ L"Proto_Texture_Player_Bow_Fire_Pulse", pComponent });

	return S_OK;
}

CFire_Pulse* CFire_Pulse::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CFire_Pulse* pInstance = new CFire_Pulse(pGraphicDev);
